...
int main(void) {
    ...
    InitWindow(LARGURA_JANELA, ALTURA_JANELA, "Atividade 3 - Completo (Exercicios 1 e 2)");
    SetTargetFPS(60);
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawText("Vermelho=Arma | Verde=Pocao | Roxo=Pocao Venenosa | Azul=Escudo", 10, 34, 16, GRAY);
